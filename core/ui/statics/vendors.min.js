(function(a) {
    ...
    function k() {
        ...
        this._initBody = function(a) {
            ...
            if (typeof a === "string") {
                this._bodyText = a;
            } else if (b.blob && Blob.prototype.isPrototypeOf(a)) {
                this._bodyBlob = a;
                ...
                this._bodyText = "";
            } else if (b.arrayBuffer && ArrayBuffer.prototype.isPrototypeOf(a)) {} else {
    ...
    function m(a) {
        var b = a.toUpperCase();
        return l.indexOf(b) > -1 ? b : a;
    }
    function n(a, b) {
        b = b || {};
        var c = b.body;
        if (n.prototype.isPrototypeOf(a)) {
            if (a.bodyUsed) {
    ...
    function o(a) {
        ...
        a.trim().split("&").forEach(function(a) {
            if (a) {
                var c = a.split("=");
                var d = c.shift().replace(/\+/g, " ");
                var e = c.join("=").replace(/\+/g, " ");
    ...
    function p(a) {
        var b = new f();
        var c = (a.getAllResponseHeaders() || "").trim().split("\n");
    ...
    function q(a, b) {
        ...
        this.headers = b.headers instanceof f ? b.headers : new f(b.headers);
        this.url = b.url || "";
        this._initBody(a);
    }
    k.call(q.prototype);
    ...
    a.fetch = function(a, c) {
        return new Promise(function(d, e) {
            var f;
            if (n.prototype.isPrototypeOf(a) && !c) {
                f = a;
            } else {
                f = new n(a, c);
            }
            ...
            function h() {
                ...
                if (/^X-Request-URL:/im.test(g.getAllResponseHeaders())) {
                    return g.getResponseHeader("X-Request-URL");
                }
                return;
            }
            g.onload = function() {
            ...
            if (f.credentials === "include") {
                g.withCredentials = true;
            }
            if ("responseType" in g && b.blob) {
                g.responseType = "blob";
            }
            f.headers.forEach(function(a, b) {
                g.setRequestHeader(b, a);
            });
            g.send(typeof f._bodyInit === "undefined" ? null : f._bodyInit);
        });
    };
    a.fetch.polyfill = true;
...
!function(global, setTimeout) {
    ...
    function newContext(a) {
        ...
        function c(a, c, d) {
            ...
            if (a && (a = a.split("/"), k = a.length - 1, x.nodeIdCompat && jsSuffixRegExp.test(a[k]) && (a[k] = a[k].replace(jsSuffixRegExp, "")), 
            "." === a[0].charAt(0) && q && (p = q.slice(0, q.length - 1), a = p.concat(a)), 
            b(a), a = a.join("/")), d && r && (q || s)) {
                g = a.split("/");
                a: for (h = g.length; h > 0; h -= 1) {
                    if (j = g.slice(0, h).join("/"), q) for (i = q.length; i > 0; i -= 1) if (f = getOwn(r, q.slice(0, i).join("/")), 
                    f && (f = getOwn(f, j))) {
                        l = f, m = h;
                        break a;
                    }
        ...
        function g(a, b, d, e) {
            ...
            h = getOwn(C, k)), a && (k ? o = h && h.normalize ? h.normalize(a, function(a) {
                return c(a, l, e);
            }) : a.indexOf("!") === -1 ? c(a, l, e) : a : (o = c(a, l, e), j = f(o), k = j[0], 
    ...
    if ("undefined" == typeof define) {
        ...
        req.createNode = function(a, b, c) {
            ...
            d.src = c, e.onNodeCreated && e.onNodeCreated(d, e, b, c), currentlyAddingScript = d, 
            baseElement ? head.insertBefore(d, baseElement) : head.appendChild(d), currentlyAddingScript = null, 
            d;
            if (isWebWorker) try {
            ...
            !b && isFunction(c) && (b = [], c.length && (c.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function(a, c) {
                b.push(c);
            ...
            e = contexts[d.getAttribute("data-requirecontext")])), e ? (e.defQueue.push([ a, b, c ]), 
